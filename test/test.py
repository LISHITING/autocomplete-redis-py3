...
class TestAutocomplete(unittest.TestCase):
    def setUp(self):
        self.items = [{"uid": '1', "score": 9, "term": "轻轻地你走了"},
                      {"uid": '2', "score": 10, "term": "正如你轻轻地来"},
                      {"uid": '3', "score": 8.5, "term": "你挥一挥衣袖，不带走一片云彩"},
                      ]
